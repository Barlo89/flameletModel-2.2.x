...
#include "OpenSMOKE_laminar_Flamelet_Library.hpp"
#include "OpenSMOKE_laminar_Flamelet.hpp"
#include "OpenSMOKE_ChiDistribution.hpp"

OpenSMOKE_laminar_Flamelet_Library::OpenSMOKE_laminar_Flamelet_Library()
{
	_name = "[not assigned]";
...
void OpenSMOKE_laminar_Flamelet_Library::SetLibraryPath(const string path_library)
{
	_path_library = path_library;
}

void OpenSMOKE_laminar_Flamelet_Library::UnsetExcludeColdFlamelets()
{
	_iExcludeColdFlamelets = false;
}

void OpenSMOKE_laminar_Flamelet_Library::SetLogNormalChiDistribution(const double sigma, const int number_of_points)
{
...
void OpenSMOKE_laminar_Flamelet_Library::SetSpeciesToExtract(const vector<string> names)
{
	_number_of_species_to_extract = names.size()-1;
	_names_of_species_to_extract = names;
}

void OpenSMOKE_laminar_Flamelet_Library::Read()
{
	int i;
	string tag;
...
void OpenSMOKE_laminar_Flamelet_Library::GetMeanValues(const double csi, const double chi_st, vector<double>& extracted)
{
	if (_iMultiScalarDissipationRates == true)
	{
		if(_iChiPDF == CHI_PDF_LOG_NORMAL)	
		{	
			GetMeanValuesMultiScalarDissipationRatesLogNormal(csi, chi_st, extracted);
		}
		else
			GetMeanValuesMultiScalarDissipationRatesDirac(csi, chi_st, extracted);
	}
	else											
		_flame[1].GetMeanValues(csi, csiv2, extracted);
}

void OpenSMOKE_laminar_Flamelet_Library::GetMeanValuesMultiScalarDissipationRatesDirac(const double csi, const double csiv2, const double chi_st, vector<double>& extracted)
{
...
void OpenSMOKE_laminar_Flamelet_Library::GetMeanValuesMultiScalarDissipationRatesLogNormal(const double csi, const double csiv2, const double chi_st, vector<double>& extracted)
{
...
void OpenSMOKE_laminar_Flamelet_Library::ExtractMeanValues(const double csi, const double csiv2, const double chi_st, vector<double> &omegaFavre)
{
	if (_iMultiScalarDissipationRates == true)
	{
		if(_iChiPDF == CHI_PDF_LOG_NORMAL)		
...
void OpenSMOKE_laminar_Flamelet_Library::ExtractMeanValuesMultiScalarDissipationRatesDirac(const double csi, const double csiv2, const double chi_st, vector<double> &omegaFavre)
{
	if (chi_st <= _chi_st_min)	
	{
		_flame[1].ExtractMeanValues(csi, csiv2, omegaFavre);
...
void OpenSMOKE_laminar_Flamelet_Library::ExtractMeanValuesMultiScalarDissipationRatesLogNormal(const double csi, const double csiv2, const double chi_st, vector<double> &omegaFavre)
{
	_chi_pdf.AssignMeanScalarDissipationRate(chi_st);
...
void OpenSMOKE_laminar_Flamelet_Library::Summary()
{
	cout << endl;
	cout << "OpenSMOKE_laminar_Flamelet_Library" << endl;
...
void OpenSMOKE_laminar_Flamelet_Library::ErrorMessage(const string error_message)
{
	cout << "OpenSMOKE_laminar_Flamelet Error" << endl;
	cout << "File name:     " << _name << endl;
	cout << "Error message: " << error_message << endl;
	exit(-1);
}

void OpenSMOKE_laminar_Flamelet_Library::WarningMessage(const string warning_message)
{
	cout << "OpenSMOKE_laminar_Flamelet Warning" << endl;
	cout << "File name:       " << _name << endl;
