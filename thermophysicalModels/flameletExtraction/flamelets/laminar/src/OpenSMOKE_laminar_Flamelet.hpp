...
#ifndef OpenSMOKE_laminar_Flamelet_H
#define OpenSMOKE_laminar_Flamelet_H

enum extraction_modes {OPENSMOKE_FLAMELET_EXTRACTION_ADIABATIC, OPENSMOKE_FLAMELET_EXTRACTION_NONADIABATIC};

class OpenSMOKE_laminar_Flamelet
{

public:
	
	OpenSMOKE_laminar_Flamelet();
...
#endif // #ifndef OpenSMOKE_laminar_Flamelet_H
