...
#ifndef OpenSMOKE_laminar_NonAdiabaticFlamelet_Library_H
#define OpenSMOKE_laminar_NonAdiabaticFlamelet_Library_H
...
class OpenSMOKE_laminar_NonAdiabaticFlamelet_Library
{

public:

	OpenSMOKE_laminar_NonAdiabaticFlamelet_Library();
	void Read();
	void Summary();
	
	void   GetMeanValues(const double csi, const double chi_st, const double phi, vector<double>& extracted);
...
private:
	...
	OpenSMOKE_laminar_Flamelet_Library *flamelet_libraries;
...
#endif // OpenSMOKE_laminar_Flamelet_NonAdibaticLibrary_H
