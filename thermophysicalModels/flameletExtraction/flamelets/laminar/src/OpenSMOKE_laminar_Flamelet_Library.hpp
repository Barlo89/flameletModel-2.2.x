...
#ifndef OpenSMOKE_laminar_Flamelet_Library_H
#define OpenSMOKE_laminar_Flamelet_Library_H

#include "OpenSMOKE_laminar_Flamelet.hpp"
#include "OpenSMOKE_ChiDistribution.hpp"
#include "OpenSMOKE_External_Functions.hpp"

class OpenSMOKE_laminar_Flamelet_Library
{

public:

	OpenSMOKE_laminar_Flamelet_Library();
	void Read();
	void Summary();
...
private:
	...
	std::vector< OpenSMOKE_laminar_Flamelet > _flame;	// Flamelets
...
#endif // OpenSMOKE_laminar_Flamelet_Library_H
