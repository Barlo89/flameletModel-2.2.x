...
#include "OpenSMOKE_laminar_NonAdiabaticFlamelet_Library.hpp"
#include "OpenSMOKE_laminar_Flamelet.hpp"
#include "OpenSMOKE_ChiDistribution.hpp"

OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::OpenSMOKE_laminar_NonAdiabaticFlamelet_Library()
{
	_name = "[not assigned]";
...
void OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::SetLibraryPath(const string path_library)
{
	_path_library = path_library;
}

void OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::UnsetExcludeColdFlamelets()
{
	_iExcludeColdFlamelets = false;
}

void OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::SetLogNormalChiDistribution(const double sigma, const int number_of_points)
{
...
void OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::SetSpeciesToExtract(const vector<string> names)
{
	number_of_species_to_extract_ = names.size()-1;
	names_of_species_to_extract_ = names;
}

void OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::SetSpeciesToExtract(const string list_of_names)
{
	vector<string> names;
...
void OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::SetAdiabaticMode()
{
	_adiabatic_mode = true;
}

int OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::number_of_species()
{
	return number_of_species_to_extract_;
}

const vector<string> OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::species()
{
	return names_of_species_to_extract_;
}

int OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::index_of_species(const string name)
{
...
void OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::Read()
{
	int i;
	string tag;
	...
	flamelet_libraries = new OpenSMOKE_laminar_Flamelet_Library[_nphi+1];
...
void OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::GetMeanValues(const double csi, const double chi_st, const double phi, vector<double>& extracted)
{
	cout << "Z: " << csi << "\t" << "Chi: " << chi_st << "\t Defect: " << phi << endl;

	if (_adiabatic_mode == true)
	{
		flamelet_libraries[1].GetMeanValues(csi, chi_st, extracted);
	}

	else
	{
		cout << "NonAdiabatic - code" << endl;
	}
}

void OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::GetMeanValues(const double csi, const double csiv2, const double chi_st, const double phi, vector<double>& extracted)
{
	if (_adiabatic_mode == true
	{
...
double OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::GetEnthalpyDefectFromTemperature(const double csi, const double csiv2, const double chi_st, const double T)
{
...
void OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::ExtractMeanValues(const double csi, const double csiv2, const double chi_st, const double phi, vector<double> &omegaFavre)
{
	if (_adiabatic_mode == true)
	{
...
void OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::Summary()
{
	cout << endl;
	cout << "OpenSMOKE_laminar_NonAdiabaticFlamelet_Library" << endl;
...
void OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::ErrorMessage(const string error_message)
{
	cout << "OpenSMOKE_laminar_NonAdiabaticFlamelet_Library Error" << endl;
	cout << "File name:     " << _name << endl;
	cout << "Error message: " << error_message << endl;
	exit(-1);
}

void OpenSMOKE_laminar_NonAdiabaticFlamelet_Library::WarningMessage(const string warning_message)
{
	cout << "OpenSMOKE_laminar_NonAdiabaticFlamelet_Library Warning" << endl;
	cout << "File name:       " << _name << endl;
