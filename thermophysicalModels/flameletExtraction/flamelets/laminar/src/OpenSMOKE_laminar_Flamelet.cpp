...
OpenSMOKE_laminar_Flamelet::OpenSMOKE_laminar_Flamelet()
{
	_name = "NULL";
	_index = 0;
...
void OpenSMOKE_laminar_Flamelet::SetSpeciesToExtract(const vector<string> names)
{
	_number_of_species_to_extract = names.size()-1;
	_names_of_species_to_extract = names;
}

void OpenSMOKE_laminar_Flamelet::Read(const string file_name, const int index, const double chi_st)
{
	int i, j;
	string tag;
...
void OpenSMOKE_laminar_Flamelet::ReadBinary(const string file_name, const int index, const double chi_st)
{
	int i, j;
	const int SIZE = 40;
	char tag[SIZE];
...
void OpenSMOKE_laminar_Flamelet::GetMeanValues(const double csi, const double csiv2, vector<double>& extracted)
{
	int iCsi = 0;
	int jCsiv2 = 0;
...
void OpenSMOKE_laminar_Flamelet::ExtractMeanValues(const double csi, const double csiv2, vector<double> &omegaFavre)
{
	int iCsi = 0;
	int jCsiv2 = 0;
...
void OpenSMOKE_laminar_Flamelet::Summary()
{
	cout << endl;
	cout << "OpenSMOKE_laminar_Flamelet" << endl;
...
void OpenSMOKE_laminar_Flamelet::ErrorMessage(const string error_message)
{
...
void OpenSMOKE_laminar_Flamelet::WarningMessage(const string warning_message)
{
	...
	double OpenSMOKE_laminar_Flamelet::temperature_f_max()
	{
		return _temperature_f_max;
	};

	double OpenSMOKE_laminar_Flamelet::temperature_f_min()
	{
		return _temperature_f_min;
	};

	double OpenSMOKE_laminar_Flamelet::density_r_max()
	{
		return _density_r_max;
	};

	double OpenSMOKE_laminar_Flamelet::density_r_min()
	{
		return _density_r_min;
	};

	bool OpenSMOKE_laminar_Flamelet::cold()
	{
		return _cold;
	};
	
	double OpenSMOKE_laminar_Flamelet::density_r_fuel()
	{
		return _density_r[1][_n_csi];
	};

	double OpenSMOKE_laminar_Flamelet::density_r_oxidizer()
	{
		return _density_r[1][1];
	};
	
	double OpenSMOKE_laminar_Flamelet::enthalpy_f_fuel()
	{
		return _enthalpy_f[1][_n_csi];
	};

	double OpenSMOKE_laminar_Flamelet::enthalpy_f_oxidizer()
	{
		return _enthalpy_f[1][1];
	};
	
	double OpenSMOKE_laminar_Flamelet::temperature_f_fuel()
	{
		return _temperature_f[1][_n_csi];
	};
	
	double OpenSMOKE_laminar_Flamelet::temperature_f_oxidizer()
	{
